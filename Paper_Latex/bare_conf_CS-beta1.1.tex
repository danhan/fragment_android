...
%worsening.
The fragmentation of the Android ecosystem causes portability and compatibility 
issues among different product lines,
which disappoints users, adds workload for developers, and delays deployment. 
Many existing studies on fragmentation roughly demonstrate basic statistics \cite{androidfragmentation}\cite{uglyhead}\cite{boonorbane}, 
...
\caption{Common Topics relevance in HTC and Motorola. X axis is months from Jan. 2009 to Dec. 2011. Y axis is the average relevance of topics.}
\label{fixtopic}
%\end{figure*}
