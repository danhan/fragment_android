...
The hyper-parameters $\alpha$ and $\beta$ of Labeled-LDA are both 0.1.
...
%TODO 3 edit according to the review
...
the number of topics to be $n = 30$. The hyper-parameters $\alpha$ and $\beta$ for LDA are also both 0.1. 
