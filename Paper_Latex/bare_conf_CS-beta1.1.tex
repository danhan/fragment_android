...
Labeled-LDA (Latent Dirichlet Allocation) on the labeled data and LDA
on the data without manual labels to infer their topics. Finally, by
...
topics into two types: \textit{Common Topics} and \textit{Unique
  Topics}. 
Some of the \textit{Common Topics} show
...
indexing the texts automatically in information retrieval. %XXX cite lukins
