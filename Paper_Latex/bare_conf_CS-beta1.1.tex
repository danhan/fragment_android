...
exactly it may impact consumer opinion.
...
(Labeled-LDA) \cite{Linstead:2009}. We applied both
labeled-LDA\cite{labeledlda} and LDA~\cite{blei} topic-analysis on the bug reports
