...
relevant to a LDA topic and those relevant to a Labelled-LDA
topic. Because the LDA topic might be different from the Labelled-LDA
...
the Jaccard similarity coefficients. We eventually chose $0.2$ as it
was the mean of the similarities.
We plotted these pairwise tests in order to explore the match between
LDA and Labelled-LDA.
